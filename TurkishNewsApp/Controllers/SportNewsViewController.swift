...
class SportNewsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        getNews(newsInput: K.NewsCategories.sport) { data in
            self.newsArray = data
...
extension SportNewsViewController: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return newsArray.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: K.Identifiers.sportNewsCell, for: indexPath) as! SportNewsCell
